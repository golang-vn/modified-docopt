...
# Modified docopt-ng 0.9.0. (c)opyleft by tuanhace 2023-12-20. All rights removed.
#
# Installation:
#   Step 1. Install docopt-ng
#       $ pip3 install docopt-ng==0.9.0
#   Step 2. Download modified docopt-ng.py
    ...
    if matched:
        ...
        for each_item in left:
            if isinstance(each_item, Option):
                k = each_item.short if each_item.short is not None else each_item.longer if each_item.longer is not None else ""
        ...
        return output_obj, left_str.strip()
